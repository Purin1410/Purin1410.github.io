...
export const credentials = [
  ...
  credential('deep-learning', 'Deep Learning', 'DeepLearning.AI', '2024-11-18', 'Specialization', 'ai', 'specialization/V53DHCIYUFQT', 'Deep Learning.pdf', true),
  credential('nlp', 'Natural Language Processing', 'DeepLearning.AI', '2025-02-15', 'Specialization', 'ai', 'specialization/PUBU3HAXQZ2C', 'Natural Language Processing.pdf', true),
  ...
  credential('research-methodologies', 'Research Methodologies', 'Queen Mary University of London', '2025-05-18', 'Course', 'research', '0X1N8XYXNIAC', 'Research Methodologies.pdf'),
  ...
  credential('project-management', 'Project Management Principles and Practices', 'University of California, Irvine', '2025-05-18', 'Specialization', 'management', 'specialization/VYTC3ZA1FV6F', 'Project Management Principles and Practices.pdf'),
];
